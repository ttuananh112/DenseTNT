DATA_DIR=/home/anhtt163/dataset/prediction/argoverse/forecasting_train_v1.1/train/data/; \
...
--core_num 1 --use_centerline --other_params semantic_lane direction l1_loss \

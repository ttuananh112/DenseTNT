...
def get_sub_map(args: utils.Args,
    ...
    if args.not_use_api:
        ...
        polygons = [polygon[:, :2].copy() for polygon in polygons]  # get x,y only?

        # ##
        # # distance of 2 consecutive points is approximately 1.9
        # # each polygon have 10 points
        # plt.plot(x, y)
        # plt.show()
        # ##
    ...
    def __init__(self, args, batch_size, to_screen=True):
        ...
        if args.reuse_temp_file:
            ...
            if args.core_num >= 1:
                ...
                # wait for getting all items in queue!
